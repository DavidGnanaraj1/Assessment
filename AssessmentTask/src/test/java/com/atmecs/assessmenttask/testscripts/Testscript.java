...
import com.atmecs.assessmenttask.pageactions.PhptravelsHelpers;
...
public class Testscript extends TestBase {
	...
	public void bookingAutomation() throws IOException, InterruptedException {
	   pageactions.sendKeys(driver,properties.getProperty("loc.usernameinputbox"),testdata.getProperty("expdata.username"));
       ...
       Thread.sleep(3000);
       WebElement bookingstab=driver.findElement(separatelocator.separatingLocators(properties.getProperty("loc.bookingstab")));
       WebElement invoiceelement=driver.findElement(separatelocator.separatingLocators(properties.getProperty("loc.invoiceelement")));
       ...
       phptravelshelpers.invoiceDetailsValidation(driver, 5);
