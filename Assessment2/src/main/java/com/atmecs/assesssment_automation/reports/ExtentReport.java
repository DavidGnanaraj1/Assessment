...
public class ExtentReport {
		...
		public  void getReport(ITestResult result) throws Exception {
			if (result.getStatus() == ITestResult.FAILURE) {
				exttest.log(LogStatus.FAIL, "Test Case Failed is " + result.getName());
				exttest.log(LogStatus.FAIL, "Test Case Failed is " + result.getThrowable());

				String screenshotPath = getScreenshot(driver, result.getName());

				exttest.log(LogStatus.FAIL, exttest.addScreenCapture(screenshotPath));
			} else if (result.getStatus() == ITestResult.SKIP) {
				exttest.log(LogStatus.SKIP, "Test Case Skipped is " + result.getName());
			}
